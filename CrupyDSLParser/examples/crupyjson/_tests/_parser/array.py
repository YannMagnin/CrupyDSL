...
def json_test_parser_array(parser: CrupyParserBase) -> None:
    ...
    assert node['node_list'][0]['name'] == 'json_statement'
    assert node['node_list'][0]['node']['name'] == 'json_container'
    ...
    assert node['node_list'][1]['name'] == 'json_statement'
    assert node['node_list'][1]['node']['name'] == 'json_container'
